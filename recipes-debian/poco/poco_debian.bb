# base recipe: meta-openembedded/meta-oe/recipes-support/poco/poco_1.9.0.bb
# base branch: warrior
# base commit: 11165418e6e869edb31f9c5c1d39136ce1dc8ec1
...
require recipes-debian/sources/poco.inc

SRC_URI += " \
    file://run-ptest \
   "

DEBIAN_UNPACK_DIR = "${WORKDIR}/${BP}-all"
S = "${WORKDIR}/${BP}-all"
