# base recipe: meta/recipes-connectivity/inetutils/inetutils_1.9.4.bb
# base branch: warrior
# base commit: 9eb09f7af38850cd6a3e9a90d4240e4f42c6765a
...
FILESPATH_append = ":${COREBASE}/meta/recipes-connectivity/inetutils/inetutils"
...
do_install_append () {
    ...
    # copy man pages from debian
    install -dm755 ${D}${mandir}/man1
    install -m644 ${S}/debian/local/man/hostname.1 ${D}${mandir}/man1/hostname.1
    install -m644 ${S}/debian/local/man/logger.1 ${D}${mandir}/man1/logger.1
    install -m644 ${S}/debian/local/man/dnsdomainname.1 ${D}${mandir}/man1/dnsdomainname.1

    install -dm755 ${D}${mandir}/man8
     install -m644 ${S}/debian/local/man/syslogd.8 ${D}${mandir}/man8/syslogd.8
