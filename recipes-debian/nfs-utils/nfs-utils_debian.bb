# base recipe: meta/recipes-connectivity/nfs-utils/nfs-utils_1.3.4.bb
...
inherit useradd debian-package
require recipes-debian/sources/nfs-utils.inc

USERADD_PACKAGES = "${PN}-client"
USERADD_PARAM_${PN}-client = "--system  --home-dir /var/lib/nfs \
			      --shell /bin/false --user-group rpcuser"

SRC_URI += "file://0001-configure-Allow-to-explicitly-disable-nfsidmap.patch \
