#base recipe: meta-openembedded/meta-oe/recipes-extended/libqb/libqb_1.0.5.bb
#base branch: dunfell
...
require recipes-debian/sources/libqb.inc

SRC_URI += "file://0001-build-fix-configure-script-neglecting-re-enable-out-.patch"
