...
python () {
   # When PV is 3.7.3~rc1, source dir name should be  Python-3.7.3rc1.
   pv = d.getVar('PV')
...
DEBIAN_UNPACK_DIR = "${WORKDIR}/${PYTHON_DEBIAN_SRC_DIR_NAME}"
...
SRC_URI += " \
           ...
           file://0001-Makefile.pre-use-qemu-wrapper-when-gathering-profile-debian-src-rebased.patch \
           file://0001-Do-not-hardcode-lib-as-location-for-site-packages-an-debian-src-rebased.patch \
...
SRC_URI_append_class-native = " \
           ...
           file://12-distutils-prefix-is-inside-staging-area-debian-src-rebased.patch \
           "
