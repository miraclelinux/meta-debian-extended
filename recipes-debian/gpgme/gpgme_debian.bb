# base recipe : meta/recipes-support/gpgme/gpgme_1.12.0.bb
# base branch : warrior
# base commit : f885c4cd7f1be3bad417a4c15b19062e47355922
...
DEBIAN_UNPACK_DIR="${WORKDIR}/gpgme-${PV}"

inherit debian-package
require recipes-debian/sources/${BPN}.inc

FILESPATH_append = ":${COREBASE}/meta/recipes-support/gpgme/gpgme:"
SRC_URI += "file://0001-pkgconfig.patch \
           ...
           file://0001-Revert-0003-python-Auto-check-for-all-installed-pyth.patch \
          "
