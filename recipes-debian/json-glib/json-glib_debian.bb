# base recipe: meta/recipes-gnome/json-glib/json-glib_1.4.4.bb
# base branch: warrior
# base commit: c2c71b71fe2b3059237b4a356726d8cbfc596266
...
inherit lib_package gobject-introspection gtk-doc gettext ptest-gnome manpages

FILESPATH_append  = ":${COREBASE}/meta/recipes-gnome/${BPN}/${BPN}"
