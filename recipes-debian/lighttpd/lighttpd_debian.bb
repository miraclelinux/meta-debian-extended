# base recipe: poky/meta/recipes-extended/lighttpd/lighttpd_1.4.53.bb
# base branch: warrior
# base commit: e34b0865c7deee5fac286ac076ebcbd529005247
...
require recipes-debian/sources/lighttpd.inc

FILESPATH_append = ":${COREBASE}/meta/recipes-extended/lighttpd/lighttpd"
SRC_URI += "file://index.html.lighttpd \
            file://lighttpd.conf \
            file://lighttpd \
