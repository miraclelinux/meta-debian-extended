# base recipe: meta/recipes-kernel/kexec/kexec-tools_2.0.19.bb
# base branch: warrior
# base commit: c8c383d958807b991e31d22f612ba2a81a3860a4

FILESPATH_append = ":${COREBASE}/meta/recipes-kernel/kexec/kexec-tools"
...
require recipes-debian/sources/kexec-tools.inc
...
SRC_URI += "file://kdump \
           ...
           file://0001-kexec-Fix-error-when-coping-coldreboot.8.patch \
           "
