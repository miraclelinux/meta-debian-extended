# base recipe: poky/meta/recipes-extended/libidn/libidn_1.35.bb
# base branch: warrior
...
FILESPATH_append = ":${COREBASE}/meta/recipes-extended/libidn/libidn/"

SRC_URI += "file://avoid_AM_PROG_MKDIR_P_warning_error_with_automake_1.12.patch \
