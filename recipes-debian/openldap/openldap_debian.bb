#base recipe: meta-openembedded/meta-oe/recipes-support/openldap/openldap_2.4.47.bb
#base branch: warrior
...
require recipes-debian/sources/openldap.inc
...
DEBIAN_UNPACK_DIR = "${WORKDIR}/openldap-2.4.47+dfsg"
