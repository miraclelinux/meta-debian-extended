#base recipe: meta-openembedded/meta-networking/recipes-daemons/openhpi/openhpi_3.8.0.bb
#base branch: dunfell
...
require recipes-debian/sources/openhpi.inc
...
EXTRA_OECONF += " --enable-cpp_wrappers"
